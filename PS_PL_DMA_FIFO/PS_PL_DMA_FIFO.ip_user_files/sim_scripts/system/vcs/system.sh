...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/my_stream_ip_v1_0_v1_0/src/my_stream_ip.v" \
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/my_stream_ip_v1_0_v1_0/src/my_stream_ip_v1_0.v" \
    "$ref_dir/../../../bd/system/ip/system_my_stream_ip_v1_0_0_0/sim/system_my_stream_ip_v1_0_0_0.v" \
  2>&1 | tee -a vlogan.log
